  ...
  public void onPreviewFrame(final byte[] bytes, final Camera camera) {
    ...
    try {
      ...
      if (rgbBytes == null) {
        ...
        Log.d("###CamAct:", "onPreviewFrame() previewHeight= " + previewHeight + " width= " +previewWidth);
    ...
    imageConverter =
        new Runnable() {
          @Override
          public void run() { // convertYUV420ToARGB8888
          ...
          CameraConnectionFragment.newInstance(
              new CameraConnectionFragment.ConnectionCallback() {
                ...
                public void onPreviewSizeChosen(final Size size, final int rotation) {
                  ...
                  Log.d("###CamAct:", "setFragm onPreviewSizeChosen() previewHeight= "
